										...
										<div class="container" style="color:#060505;">
											<div class="row">
												...
												<div class='col-sm-6' id="grupo__ruc_postulante">
													...
													<div class="form-group">
														<div class='input-group date'>
															<input type='text' class="formulario__input" autocomplete="off" name="ruc_postulante" id="ruc_postulante" style="text-transform:uppercase;" onkeypress="return valideKey(event);" minlength="9" maxlength="13" value="<?php if (isset($ruc_postulante)) echo $ruc_postulante ?>" title="El RUC solo debe contener numeros y letras" required />
															<i class="formulario__validacion-estado fas fa-times-circle"></i>
														</div>
														<p class="formulario__input-error">El RUC y/o C.I tiene que ser de 10 a 13 dígitos y puede contener numeros y/o letras de acuerdo a cada país.</p>
													</div>
												</div>
											</div>
