                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <img src="../Fotos_Perfil/<?php echo $row['nombre_usuario'] ?>/<?php echo $row['nombre_usuario']; ?>.JPG" alt="..." class="img-circle profile_img">
                        </div>
                        <div class="profile_info">
                            <h2 style="text-align:center"><?php echo  $row['nombre_usuario'] . " " . $row['apellido_usuario']; ?></h2>
                        </div>
                        <div class="menu_section">
                            <h3 style="text-align:center"><?php echo  $row['nombre_perfil']; ?></h3>
                        </div>
                    </div>
                    <!-- /menu profile quick info -->
                            ...
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-edit"></i> Formularios <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="usuarios_ingreso.php">Ingreso de Usuarios</a></li>
