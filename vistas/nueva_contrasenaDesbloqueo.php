    ...
    <div class="page-content">
        <div class="form-v8-content">
            ...
            <div class="form-right">
                <?php
                ?>
                <form class="form-detail" id="formNuevaContrasena" name="formNuevaContrasena" method="POST" action="nueva_contrasenaDesbloqueo.php">
                    <div class="tabcontent" id="sign-in">
                        <center>
                            <div class="container">
                                <div class="jumbotron">
                                    <h1>CAMBIO DE CONTRASEÑA POR BLOQUEO DE CUENTA</h1>
