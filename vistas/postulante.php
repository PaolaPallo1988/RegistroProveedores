                                ...
                                <div>
                                    <h2 align="justify">
                                        <div style="color:#060505;" class="interlineado">El Ministerio de Defensa Nacional del Ecuador inicia un sistema de registro de proveedores. <br><br>
                                            ...
                                            <b>Alcance:</b><br>
                                            El trámite está orientado a calificación, ampliación de bienes estratégicos y/o prestación de servicios conexos, inscripción, habilitación, actualización, suspensión temporal o definitiva en el Registro de Proveedores de Bienes Estratégicos y Servicios Conexos (RPBE).
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            ...
                            <h2 id='demo5' class='collapse'>
                                <div class="interlineado">
                                    <ul style="color:#060505;">
                                        ...
                                        <ol style="color:#060505;">
                                            <li> &nbsp;&nbsp; Realizar el pre registro en línea, ingresando la información de forma digital al Sistema y entregar la documentación física en el Ministerio de Defensa Nacional del Ecuador.</li>
                                            <li> &nbsp;&nbsp; Llenar los formularios en línea y descargar los formularios para la firma, escaneo y carga de los mismos en el sistema </li>
                                            <li> &nbsp;&nbsp; Cargar en el sistema los respaldos digitales de los requisito conforme la naturaleza de su personería (natural, jurídica, nacional o extranjera) </li>
