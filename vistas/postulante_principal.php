                            ...
                            <form class="form-label-left input_mask" name="postulante_principal" method="POST" id="postulante_principal" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                                ...
                                <div class="x_panel"><br>
                                    <div class="container p-2 my-2 text-white" style="background-color:#0A307C">
                                        <font size=5> POSTULANTE ( los campos marcados con * son obligatorios)</font>
                                    ...
                                    <div class="x_content" style="color:black">
                                        ...
                                        <div class="row">
                                            <div class='col-sm-6'>
                                                ...
                                                <div class="form-group">
                                                    <div class='input-group date'>
                                                        <input type='text' style="background-color:#E0F3E7" class="formulario__input" name="nombre_postulante" id="nombre_postulante" style="text-transform:uppercase;" value="<?php echo  $row['nombre_usuario']; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled />
                                                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <title class="formulario__label"> DIRECCION EN EL PAÍS DE ORIGEN * </title>
                                        <div class="row">
                                        ...
                                        <title class="formulario__label"> DIRECCION EN EL ECUADOR * </title>
                                        <div class="row">
                                ...
                                <div class="x_panel">
                                    ...
                                    <!--<div id="titulo_apoderado_ecuador" style="display:none;">
                                        <div class="container p-2 my-2 text-white" style="background-color:#0A307C">
                                            <font size=5> APODERADO EN ECUADOR </font>
                                            <ul class="nav navbar-right panel_toolbox">
                                                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                                </li>
                                            </ul>
                                ...
                                <div class="x_panel"><br>
                                    ...
                                    <div class="x_content" style="color:black">
                                        <div class='col-sm-4' id='grupo__capital_privado'>
                                            <label class="formulario__label"> PRIVADO </label>
                                            <div class="form-group">
                                                <div class='input-group date'>
                                                    <input type="text" class="formulario__input" name="capital_privado" id="capital_privado" placeholder="Formato requerido 1.256.566,06" onkeypress="return validaCantidad(event)" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
                                                <p class="formulario__input-error"> Si no posee información deje el campo vacío </p>
                                            </div>
                                        </div>
                                        <div class='col-sm-4' id='grupo__capital_estatal'>
                                            <label class="formulario__label"> ESTATAL </label>
                                            <div class="form-group">
                                                <div class='input-group date'>
                                                    <input type="text" class="formulario__input" name="capital_estatal" id="capital_estatal" placeholder="Formato requerido 1.256.566,06" onkeypress="return validaCantidad(event)" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
                                                <p class="formulario__input-error"> Si no posee información deje el campo vacío </p>
                                            </div>
                                        </div>
                                        <div class='col-sm-4' id='grupo__capital_mixto'>
                                            <label class="formulario__label"> MIXTO </label>
                                            <div class="form-group">
                                                <div class='input-group date'>
                                                    <input type="text" class="formulario__input" name="capital_mixto" id="ciudad_mixto" placeholder="Formato requerido 1.256.566,06" onkeypress="return validaCantidad(event)" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
                                                <p class="formulario__input-error"> Si no posee información deje el campo vacío </p>
                                            </div>
                                ...
                                <div class="x_panel"><br>
                                    ...
                                    <div class="x_content" style="color:black">
                                        <div class='col-sm-4' id='grupo__estado_decurrente'>
                                            <label class="formulario__label"> AÑO INMEDIATO ANTERIOR * </label>
                                            <div class="form-group">
                                                <div class='input-group date'>
                                                ...
                                                <p class="formulario__input-error"> Recuerde: el año de los estados financieros debe ser menor al año actual </p>
                                            </div>
                                        </div>
