                        ...
                        <div class="x_panel"> <br />
                            <div class="x_title"><br>
                                <h2 style="color:black">
                                    <FONT SIZE=5><b>ACTIVAR / DESACTIVAR ADMINISTRATIVOS</b></FONT>
                                </h2>
                                <div class="clearfix"></div>
                            </div>
                            <form class="form-label-left input_mask" method="POST" action="usuario_desactiva.php">
                                <?php
                                include('../controlador/inactiva_usuario.php');
                                //Primero tienes que validar que llegue un dato, lo hice con una condición ternaria
                                $id_usuario_desactiva = !empty($_GET['id_usuario_desactiva']) ? $_GET['id_usuario_desactiva'] : null;
                                ...
                                $perfil_id = !empty($registrousu['perfil_if']) ? $registrousu['perfil_id'] : null;
                                ...
                                $sql = "SELECT * FROM usuario u INNER JOIN perfil p INNER JOIN estado e ON e.id_estado=u.estado_id AND p.id_perfil = u.perfil_id AND u.id_usuario='" . $id_usuario_desactiva . "'";
                                    ...
                                    <font size="3" face="arial">
                                            ...
                                            <div class='col-sm-6'>
                                                ...
                                                <div class="form-group">
                                                    <div class='input-group date' id='myDatepicker2'>
                                                        <input type='text' class="form-control" required name="apellido_usuario" id="apellido_usuario" value="<?php echo $apellido_usuario ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled />
                                                        <span class="input-group-addon">
                                                            <span class="fa fa-user"></span>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class='col-sm-6'><br>
                                                ...
                                                <div class="form-group">
                                                    <select id="heard" class="form-control" name="perfil_id" id="perfil_id" disabled>
                                                        <option value="<?php echo $perfil_id ?>"><?php echo $nombre_perfil ?></option>
                                            ...
                                            <div class='col-sm-6'><br>
                                                ...
                                                <div class="form-group">
                                                    <select id="heard" class="form-control" name="estado_id" id="estado_id">
                                                        <option value="<?php echo $estado_id ?>"><?php echo $nombre_estado ?></option>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-9 col-sm-9  offset-md-3"><br>
                                        <button style="background-color:#0A307C" type="submit" id="inactivausuario" name="inactivausuario" class="boton btn btn-primary">ACTUALIZAR</button>
