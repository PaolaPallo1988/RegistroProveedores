...
if (isset($_POST['guarda_oferta'])) {
    ...
    $armamento_opt9 = mysqli_real_escape_string($conn_registro, (strip_tags($_POST["armamento_opt9"] ?? null, ENT_QUOTES)));
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $sqlcalificacion = "INSERT INTO producto_oferta  (usuario_id_oferta,cedula_postulante_oferta,
                                ...
                                c4ivr_opt1,areonavefija_opt2,defensaaerea_opt3,aeronaverot_opt4,armamento_opt5,combate_opt6, blindados_opt7,contramedidas_opt8, armamento_opt9, armamento_opt10) VALUES 
                                ('" . $usuario_id . "','" . $cedula_postulante . "',
                                '" . $c4ivr_opt1 . "','" . $areonavefija_opt2 . "','" . $defensaaerea_opt3 . "','" . $aeronaverot_opt4 . "','" . $armamento_opt5 . "','" . $combate_opt6 . "','" . $blindados_opt7 . "','" . $contramedidas_opt8 . "','" . $armamento_opt9 . "','" . $armamento_opt10 . "',
                                '" . $option1 . "','" . $option2 . "','" . $option3 . "','" . $option4 . "','" . $option5 . "','" . $option6 . "','" . $option7 . "','" . $option8 . "','" . $option9 . "','" . $option10 . "')";
