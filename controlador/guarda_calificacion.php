...
if (isset($_POST['guardacalificacion'])) {
    ...
    $capital_privado = mysqli_real_escape_string($conn_registro, (strip_tags($_POST["capital_privado"] ?? NULL, ENT_QUOTES)));
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $nombre_archivo = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_GENERALES" . "-" .  "SOLICITUD_CALIFICACIÓN" . ".PDF";
        $nombre_archivo1 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_GENERALES" . "-" .  "FORMULARIO_DATOS_GENERALES" . ".PDF";
        $nombre_archivo2 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_GENERALES" . "-" . "ACREEDITACIÓN_CAPACIDAD_EXPERIENCIA  " . ".PDF";
        $nombre_archivo3 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_GENERALES" . "-" .  "SERVICIOS_CONEXOS_OFERTA" . ".PDF";
        $nombre_archivo4 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_GENERALES" . "-" .  "DECLARACIÓN_JURAMENTADA_NOTARIO" . ".PDF";
        $nombre_archivo5 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_GENERALES" . "-" . "ESTADO_SITUACIÓN_FINANCIERA" . ".PDF";
        $nombre_archivo6 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_GENERALES" . "-" . "PODER_NOTARIZADO" . ".PDF";  // $nombre_archivo6 = $directorio . $usuario . "-" .  date("m-d-y") . "-" .  basename($_FILES["archivo6"]["name"]);

        $nombre_persona_natural1 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_ESPECIFICOS" . "-" .  "AL_DIA_OBLIGACIONES_SRI" . ".PDF";
        $nombre_persona_natural2 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_ESPECIFICOS" . "-" .  "ORIGINAL_COPIA_RUC" . ".PDF";
        $nombre_persona_natural3 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_ESPECIFICOS" . "-" .  "AL_DIA_OBLIGACIONES_IESS" . ".PDF";

        $nombre_persona_juridica1 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_ESPECIFICOS" . "-" .  "ESCRITURA_CONSTITUCION_CIA" . ".PDF";
        $nombre_persona_juridica2 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_ESPECIFICOS" . "-" .  "NOMBRAMIENTO_REPRESENTANTE_LEGAL" . ".PDF";
        $nombre_persona_juridica3 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_ESPECIFICOS" . "-" .  "AL_DIA_OBLIGACIONES_SRI" . ".PDF";
        $nombre_persona_juridica4 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_ESPECIFICOS" . "-" .  "AL_DIA_OBLIGACIONES_IESS" . ".PDF";
        $nombre_persona_juridica5 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_ESPECIFICOS" . "-" .  "ORIG_COPIA_CERTIFICADO_RUC" . ".PDF";
        $nombre_persona_juridica6 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_ESPECIFICOS" . "-" .  "NO_CONSTAR_CONTRATISTA_INCUMPLIDO" . ".PDF";

        $nombre_persona_domic1 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_ESPECIFICOS" . "-" .  "ESCRITURA_CONSTITUCION_CIA" . ".PDF";
        $nombre_persona_domic2 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_ESPECIFICOS" . "-" .  "NOMBRAMIENTO_REPRESENTANTE_LEGAL" . ".PDF";
        $nombre_persona_domic3 = $directorio . $usuario . "-" .  date("d-m-y") . "-" . "DOC_ESPECIFICOS" . "-" .  "DOC_EMITIDA_AUTORIDAD_TRIBUTARIA" . ".PDF";

        if (($id_razonsoc == '3') || ($id_razonsoc == '4')) {

            /* if (($checar_si_archivo != false) && ($checar_si_archivo1 != false) && ($checar_si_archivo2 != false) &&  ($checar_si_archivo3 != false) &&  ($checar_si_archivo4 != false) &&  ($checar_si_archivo5 != false) &&  ($checar_si_archivo6 != false) &&
                ($checar_si_persona_juridica1 != false) && ($checar_si_persona_juridica2 != false) && ($checar_si_persona_juridica3 != false) && ($checar_si_persona_juridica4 != false) && ($checar_si_persona_juridica5 != false) && ($checar_si_persona_juridica6 != false)
            ) {*/
                    ...
                    if (
                        ...
                        if ((move_uploaded_file($_FILES["archivo"]["tmp_name"], $nombre_archivo)) && (move_uploaded_file($_FILES["archivo1"]["tmp_name"], $nombre_archivo1)) && (move_uploaded_file($_FILES["archivo2"]["tmp_name"], $nombre_archivo2)) && (move_uploaded_file($_FILES["archivo3"]["tmp_name"], $nombre_archivo3)) && (move_uploaded_file($_FILES["archivo4"]["tmp_name"], $nombre_archivo4)) && (move_uploaded_file($_FILES["archivo5"]["tmp_name"], $nombre_archivo5)) && (move_uploaded_file($_FILES["archivo6"]["tmp_name"], $nombre_archivo6))
                            ...
                            $sqlcalificacion = "INSERT INTO postulante (razonsoc_id, usuario_id,cedula_postulante, siglas_postulante, actividad_postulante, distribuidor_postulante, pais_postulante, provincia_postulante, ciudad_postulante, direcPrinOrig_postulante, direcSecOrig_postulante, direcNumOrig_postulante, direcPisoOrig_postulante, teleforig_postulante,extorig_postulante,direcPrinEcu_postulante,direcSecEcu_postulante,direcNumEcu_postulante,direcPisoEcu_postulante,extecu_postulante,paginaweb_postulante,
                                    capital_privado, capital_estatal,capital_mixto,estado_decurrente, estado_balance,
        ...
        if (($id_razonsoc == '1') || ($id_razonsoc == '2')) {
            /* if (($checar_si_archivo != false) && ($checar_si_archivo1 != false) && ($checar_si_archivo2 != false) &&  ($checar_si_archivo3 != false) &&  ($checar_si_archivo4 != false) &&  ($checar_si_archivo5 != false) && ($checar_si_archivo6 != false) &&
                ($checar_si_persona_natural1 != false) && ($checar_si_persona_natural2 != false) && ($checar_si_persona_natural3 != false)
            ) {*/
            if ((!empty($_FILES["archivo"]["tmp_name"])) && !empty($_FILES["archivo1"]["tmp_name"]) && !empty($_FILES["archivo2"]["tmp_name"]) &&  !empty($_FILES["archivo3"]["tmp_name"]) &&  !empty($_FILES["archivo4"]["tmp_name"]) &&  !empty($_FILES["archivo5"]["tmp_name"]) &&  !empty($_FILES["archivo6"]["tmp_name"]) &&
        ...
        if (($id_razonsoc == '5') || ($id_razonsoc == '6')) {
            /*if (($checar_si_archivo != false) && ($checar_si_archivo1 != false) && ($checar_si_archivo2 != false) &&  ($checar_si_archivo3 != false) &&  ($checar_si_archivo4 != false) &&  ($checar_si_archivo5 != false) &&  ($checar_si_archivo6 != false) &&
                ($checar_si_persona_domic1 != false) && ($checar_si_persona_domic2 != false) && ($checar_si_persona_domic3 != false)
            ) {*/
            if ((!empty($_FILES["archivo"]["tmp_name"])) && !empty($_FILES["archivo1"]["tmp_name"]) && !empty($_FILES["archivo2"]["tmp_name"]) &&  !empty($_FILES["archivo3"]["tmp_name"]) &&  !empty($_FILES["archivo4"]["tmp_name"]) &&  !empty($_FILES["archivo5"]["tmp_name"]) &&  !empty($_FILES["archivo6"]["tmp_name"]) &&
